...
int main(int argc, char * argv[])
{
	...
	scriptHelper.borrowScriptObject()->bindCoreService("cpgf", nullptr);
	...
	scriptSetValue(scriptHelper.borrowScriptObject(), "exitDemo", GScriptValue::fromMethod(nullptr, method.get()));
