...
GDefineMetaInfo createMetaClass_Global_vector3()
{
    ...
    buildMetaClass_Global_vector3(0, _d, NULL);
...
GDefineMetaInfo createMetaClass_Vector3()
{
    GDefineMetaGlobalDangle _d = GDefineMetaGlobalDangle::dangle();
    {
        ...
        buildMetaClass_Vector3<GDefineMetaClass<Vector3<int> >, int >(0, _nd, NULL);
        _d._class(_nd);
    }
    {
        GDefineMetaClass<Vector3<float> > _nd = GDefineMetaClass<Vector3<float> >::declare("Vector3_float");
        buildMetaClass_Vector3<GDefineMetaClass<Vector3<float> >, float >(0, _nd, NULL);
        _d._class(_nd);
    }
    return _d.getMetaInfo();
}
