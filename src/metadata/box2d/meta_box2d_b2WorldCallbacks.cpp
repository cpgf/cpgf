...
GDefineMetaInfo createMetaClass_B2Color()
{
    GDefineMetaGlobalDangle _d = GDefineMetaGlobalDangle::dangle();
    {
        ...
        buildMetaClass_B2Color(0, _nd, NULL);
        _d._class(_nd);
    }
...
GDefineMetaInfo createMetaClass_B2ContactFilter()
{
    GDefineMetaGlobalDangle _d = GDefineMetaGlobalDangle::dangle();
    {
        ...
        buildMetaClass_B2ContactFilter(0, _nd, NULL);
        _d._class(_nd);
    }
    return _d.getMetaInfo();
}
...
GDefineMetaInfo createMetaClass_B2ContactImpulse()
{
    GDefineMetaGlobalDangle _d = GDefineMetaGlobalDangle::dangle();
    {
        ...
        buildMetaClass_B2ContactImpulse(0, _nd, NULL);
        _d._class(_nd);
    }
    return _d.getMetaInfo();
}
...
GDefineMetaInfo createMetaClass_B2ContactListener()
{
    GDefineMetaGlobalDangle _d = GDefineMetaGlobalDangle::dangle();
    {
        ...
        buildMetaClass_B2ContactListener(0, _nd, NULL);
        _d._class(_nd);
    }
    return _d.getMetaInfo();
}
...
GDefineMetaInfo createMetaClass_B2DebugDraw()
{
    GDefineMetaGlobalDangle _d = GDefineMetaGlobalDangle::dangle();
    {
        ...
        buildMetaClass_B2DebugDraw(0, _nd, NULL);
        _d._class(_nd);
    }
    return _d.getMetaInfo();
}
...
GDefineMetaInfo createMetaClass_B2DestructionListener()
{
    GDefineMetaGlobalDangle _d = GDefineMetaGlobalDangle::dangle();
    {
        ...
        buildMetaClass_B2DestructionListener(0, _nd, NULL);
        _d._class(_nd);
    }
    return _d.getMetaInfo();
}
...
GDefineMetaInfo createMetaClass_B2QueryCallback()
{
    GDefineMetaGlobalDangle _d = GDefineMetaGlobalDangle::dangle();
    {
        ...
        buildMetaClass_B2QueryCallback(0, _nd, NULL);
        _d._class(_nd);
    }
    return _d.getMetaInfo();
}
...
GDefineMetaInfo createMetaClass_B2RayCastCallback()
{
    GDefineMetaGlobalDangle _d = GDefineMetaGlobalDangle::dangle();
    {
        ...
        buildMetaClass_B2RayCastCallback(0, _nd, NULL);
        _d._class(_nd);
    }
    return _d.getMetaInfo();
}
