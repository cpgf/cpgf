...
GDefineMetaInfo createMetaClass_Features()
{
    GDefineMetaGlobalDangle _d = GDefineMetaGlobalDangle::dangle();
    {
        ...
        buildMetaClass_Features(0, _nd, NULL);
        _d._class(_nd);
    }
    return _d.getMetaInfo();
}
...
GDefineMetaInfo createMetaClass_B2AABB()
{
    GDefineMetaGlobalDangle _d = GDefineMetaGlobalDangle::dangle();
    {
        ...
        buildMetaClass_B2AABB(0, _nd, NULL);
        _d._class(_nd);
    }
    return _d.getMetaInfo();
}
...
GDefineMetaInfo createMetaClass_B2ClipVertex()
{
    GDefineMetaGlobalDangle _d = GDefineMetaGlobalDangle::dangle();
    {
        ...
        buildMetaClass_B2ClipVertex(0, _nd, NULL);
        _d._class(_nd);
    }
    return _d.getMetaInfo();
}
...
GDefineMetaInfo createMetaClass_B2Manifold()
{
    GDefineMetaGlobalDangle _d = GDefineMetaGlobalDangle::dangle();
    {
        ...
        buildMetaClass_B2Manifold(0, _nd, NULL);
        _d._class(_nd);
    }
    return _d.getMetaInfo();
}
...
GDefineMetaInfo createMetaClass_B2ManifoldPoint()
{
    GDefineMetaGlobalDangle _d = GDefineMetaGlobalDangle::dangle();
    {
        ...
        buildMetaClass_B2ManifoldPoint(0, _nd, NULL);
        _d._class(_nd);
    }
    return _d.getMetaInfo();
}
...
GDefineMetaInfo createMetaClass_B2RayCastInput()
{
    GDefineMetaGlobalDangle _d = GDefineMetaGlobalDangle::dangle();
    {
        ...
        buildMetaClass_B2RayCastInput(0, _nd, NULL);
        _d._class(_nd);
    }
    return _d.getMetaInfo();
}
...
GDefineMetaInfo createMetaClass_B2RayCastOutput()
{
    GDefineMetaGlobalDangle _d = GDefineMetaGlobalDangle::dangle();
    {
        ...
        buildMetaClass_B2RayCastOutput(0, _nd, NULL);
        _d._class(_nd);
    }
    return _d.getMetaInfo();
}
...
GDefineMetaInfo createMetaClass_B2WorldManifold()
{
    GDefineMetaGlobalDangle _d = GDefineMetaGlobalDangle::dangle();
    {
        ...
        buildMetaClass_B2WorldManifold(0, _nd, NULL);
        _d._class(_nd);
    }
    return _d.getMetaInfo();
}
