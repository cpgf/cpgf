...
head_file "include/cpgf/metadata/private" "*"
head_file "include/cpgf/metadata/util" "*"
head_file "include/cpgf/metadata/stl" "*"
head_file "include/cpgf/metadata/opengl" "*"

head_file "src" "*"
head_file "src/pinclude" "*"
head_file "src/scriptbind" "*"
head_file "src/metadata/opengl" "*.cpp"

head_file "samples" "*"
head_file "samples/opengl" "*"
copy_file "samples/opengl/build_vc2008" "*.vcproj"
