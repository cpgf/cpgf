...
void buildMetaClass_MetagenOperatorArithmetic(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _operator<MetagenOperatorArithmetic (*)(const cpgf::GMetaSelf &, const MetagenOperatorArithmetic &)>(mopHolder + mopHolder);
    _d.CPGF_MD_TEMPLATE _method("_opAdd", (MetagenOperatorArithmetic (*) (const MetagenOperatorArithmetic *, const MetagenOperatorArithmetic &))&opErAToRWrapper_MetagenOperatorArithmetic__opAdd, cpgf::MakePolicy<cpgf::GMetaRuleExplicitThis >());
    ...
    _d.CPGF_MD_TEMPLATE _operator<MetagenOperatorArithmetic (*)(cpgf::GMetaSelf, const MetagenOperatorArithmetic &)>(mopHolder - mopHolder);
    _d.CPGF_MD_TEMPLATE _method("_opSub", (MetagenOperatorArithmetic (*) (MetagenOperatorArithmetic *, const MetagenOperatorArithmetic &))&opErAToRWrapper_MetagenOperatorArithmetic__opSub, cpgf::MakePolicy<cpgf::GMetaRuleExplicitThis >());
    ...
    _d.CPGF_MD_TEMPLATE _operator<MetagenOperatorArithmetic (*)(cpgf::GMetaSelf, const MetagenOperatorArithmetic &)>(mopHolder * mopHolder);
    _d.CPGF_MD_TEMPLATE _method("_opMul", (MetagenOperatorArithmetic (*) (MetagenOperatorArithmetic *, const MetagenOperatorArithmetic &))&opErAToRWrapper_MetagenOperatorArithmetic__opMul, cpgf::MakePolicy<cpgf::GMetaRuleExplicitThis >());
    _d.CPGF_MD_TEMPLATE _operator<MetagenOperatorArithmetic (*)(cpgf::GMetaSelf, const std::string &)>(mopHolder * mopHolder, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1> >());
    ...
    _d.CPGF_MD_TEMPLATE _operator<MetagenOperatorArithmetic (*)(cpgf::GMetaSelf, const MetagenOperatorArithmetic &)>(mopHolder / mopHolder);
    _d.CPGF_MD_TEMPLATE _method("_opDiv", (MetagenOperatorArithmetic (*) (MetagenOperatorArithmetic *, const MetagenOperatorArithmetic &))&opErAToRWrapper_MetagenOperatorArithmetic__opDiv, cpgf::MakePolicy<cpgf::GMetaRuleExplicitThis >());
    _d.CPGF_MD_TEMPLATE _operator<MetagenOperatorArithmetic (*)(cpgf::GMetaSelf, const std::string &)>(mopHolder / mopHolder, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1> >());
    ...
    _d.CPGF_MD_TEMPLATE _operator<MetagenOperatorArithmetic (*)(cpgf::GMetaSelf, const MetagenOperatorArithmetic &)>(mopHolder % mopHolder);
    _d.CPGF_MD_TEMPLATE _method("_opMod", (MetagenOperatorArithmetic (*) (MetagenOperatorArithmetic *, const MetagenOperatorArithmetic &))&opErAToRWrapper_MetagenOperatorArithmetic__opMod, cpgf::MakePolicy<cpgf::GMetaRuleExplicitThis >());
    _d.CPGF_MD_TEMPLATE _operator<MetagenOperatorArithmetic (*)(cpgf::GMetaSelf, const std::string &)>(mopHolder % mopHolder, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1> >());
