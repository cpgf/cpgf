...
void buildMetaClass_MetagenOperatorOther(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _operator<MetagenOperatorOther & (*)(cpgf::GMetaSelf, const MetagenOperatorOther &)>(mopHolder = mopHolder);
    _d.CPGF_MD_TEMPLATE _method("_opAssign", (MetagenOperatorOther & (*) (MetagenOperatorOther *, const MetagenOperatorOther &))&opErAToRWrapper_MetagenOperatorOther__opAssign, cpgf::MakePolicy<cpgf::GMetaRuleExplicitThis >());
    ...
    _d.CPGF_MD_TEMPLATE _operator<float & (*)(cpgf::GMetaSelf, const MetagenOperatorOther &)>(mopHolder[0]);
    _d.CPGF_MD_TEMPLATE _method("_opArrayGet", (float & (*) (MetagenOperatorOther *, const MetagenOperatorOther &))&opErAToRWrapper_MetagenOperatorOther__opArrayGet, cpgf::MakePolicy<cpgf::GMetaRuleExplicitThis >());
    _d.CPGF_MD_TEMPLATE _method("_opArraySet", (void (*) (MetagenOperatorOther *, const MetagenOperatorOther &, const cpgf::RemoveReference<float & >::Result &))&opErAToRWrapper_MetagenOperatorOther__opArraySet, cpgf::MakePolicy<cpgf::GMetaRuleExplicitThis >());
