...
void buildMetaClass_MetagenOperatorLogic(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _operator<bool (*)(const cpgf::GMetaSelf &, const MetagenOperatorLogic &)>(mopHolder > mopHolder);
    _d.CPGF_MD_TEMPLATE _method("_opGreater", (bool (*) (const MetagenOperatorLogic *, const MetagenOperatorLogic &))&opErAToRWrapper_MetagenOperatorLogic__opGreater, cpgf::MakePolicy<cpgf::GMetaRuleExplicitThis >());
    ...
    _d.CPGF_MD_TEMPLATE _operator<bool (*)(const cpgf::GMetaSelf &, const MetagenOperatorLogic &)>(mopHolder >= mopHolder);
    _d.CPGF_MD_TEMPLATE _method("_opGreaterEqual", (bool (*) (const MetagenOperatorLogic *, const MetagenOperatorLogic &))&opErAToRWrapper_MetagenOperatorLogic__opGreaterEqual, cpgf::MakePolicy<cpgf::GMetaRuleExplicitThis >());
    _d.CPGF_MD_TEMPLATE _operator<bool (*)(const cpgf::GMetaSelf &, const std::string &)>(mopHolder >= mopHolder, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1> >());
    ...
    _d.CPGF_MD_TEMPLATE _operator<bool (*)(const cpgf::GMetaSelf &, const MetagenOperatorLogic &)>(mopHolder < mopHolder);
    _d.CPGF_MD_TEMPLATE _method("_opLess", (bool (*) (const MetagenOperatorLogic *, const MetagenOperatorLogic &))&opErAToRWrapper_MetagenOperatorLogic__opLess, cpgf::MakePolicy<cpgf::GMetaRuleExplicitThis >());
    _d.CPGF_MD_TEMPLATE _operator<bool (*)(const cpgf::GMetaSelf &, const std::string &)>(mopHolder < mopHolder, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1> >());
    ...
    _d.CPGF_MD_TEMPLATE _operator<bool (*)(const cpgf::GMetaSelf &, const MetagenOperatorLogic &)>(mopHolder <= mopHolder);
    _d.CPGF_MD_TEMPLATE _method("_opLessEqual", (bool (*) (const MetagenOperatorLogic *, const MetagenOperatorLogic &))&opErAToRWrapper_MetagenOperatorLogic__opLessEqual, cpgf::MakePolicy<cpgf::GMetaRuleExplicitThis >());
    _d.CPGF_MD_TEMPLATE _operator<bool (*)(const cpgf::GMetaSelf &, const std::string &)>(mopHolder <= mopHolder, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1> >());
    ...
    _d.CPGF_MD_TEMPLATE _operator<bool (*)(const cpgf::GMetaSelf &, const MetagenOperatorLogic &)>(mopHolder && mopHolder);
    _d.CPGF_MD_TEMPLATE _method("_opAnd", (bool (*) (const MetagenOperatorLogic *, const MetagenOperatorLogic &))&opErAToRWrapper_MetagenOperatorLogic__opAnd, cpgf::MakePolicy<cpgf::GMetaRuleExplicitThis >());
    _d.CPGF_MD_TEMPLATE _operator<bool (*)(const cpgf::GMetaSelf &, const std::string &)>(mopHolder && mopHolder, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1> >());
    ...
    _d.CPGF_MD_TEMPLATE _operator<bool (*)(const cpgf::GMetaSelf &, const MetagenOperatorLogic &)>(mopHolder || mopHolder);
    _d.CPGF_MD_TEMPLATE _method("_opOr", (bool (*) (const MetagenOperatorLogic *, const MetagenOperatorLogic &))&opErAToRWrapper_MetagenOperatorLogic__opOr, cpgf::MakePolicy<cpgf::GMetaRuleExplicitThis >());
    _d.CPGF_MD_TEMPLATE _operator<bool (*)(const cpgf::GMetaSelf &, const std::string &)>(mopHolder || mopHolder, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1> >());
