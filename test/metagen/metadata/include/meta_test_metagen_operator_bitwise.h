...
void buildMetaClass_MetagenOperatorBitwise(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _operator<MetagenOperatorBitwise (*)(const cpgf::GMetaSelf &, const MetagenOperatorBitwise &)>(mopHolder & mopHolder);
    _d.CPGF_MD_TEMPLATE _method("_opBitAnd", (MetagenOperatorBitwise (*) (const MetagenOperatorBitwise *, const MetagenOperatorBitwise &))&opErAToRWrapper_MetagenOperatorBitwise__opBitAnd, cpgf::MakePolicy<cpgf::GMetaRuleExplicitThis >());
    ...
    _d.CPGF_MD_TEMPLATE _operator<MetagenOperatorBitwise (*)(cpgf::GMetaSelf, const MetagenOperatorBitwise &)>(mopHolder | mopHolder);
    _d.CPGF_MD_TEMPLATE _method("_opBitOr", (MetagenOperatorBitwise (*) (MetagenOperatorBitwise *, const MetagenOperatorBitwise &))&opErAToRWrapper_MetagenOperatorBitwise__opBitOr, cpgf::MakePolicy<cpgf::GMetaRuleExplicitThis >());
    ...
    _d.CPGF_MD_TEMPLATE _operator<MetagenOperatorBitwise (*)(cpgf::GMetaSelf, const MetagenOperatorBitwise &)>(mopHolder ^ mopHolder);
    _d.CPGF_MD_TEMPLATE _method("_opBitXor", (MetagenOperatorBitwise (*) (MetagenOperatorBitwise *, const MetagenOperatorBitwise &))&opErAToRWrapper_MetagenOperatorBitwise__opBitXor, cpgf::MakePolicy<cpgf::GMetaRuleExplicitThis >());
    _d.CPGF_MD_TEMPLATE _operator<MetagenOperatorBitwise (*)(cpgf::GMetaSelf, const std::string &)>(mopHolder ^ mopHolder, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1> >());
    ...
    _d.CPGF_MD_TEMPLATE _operator<MetagenOperatorBitwise (*)(cpgf::GMetaSelf, const MetagenOperatorBitwise &)>(mopHolder << mopHolder);
    _d.CPGF_MD_TEMPLATE _method("_opLeftShift", (MetagenOperatorBitwise (*) (MetagenOperatorBitwise *, const MetagenOperatorBitwise &))&opErAToRWrapper_MetagenOperatorBitwise__opLeftShift, cpgf::MakePolicy<cpgf::GMetaRuleExplicitThis >());
    _d.CPGF_MD_TEMPLATE _operator<MetagenOperatorBitwise (*)(cpgf::GMetaSelf, const std::string &)>(mopHolder << mopHolder, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1> >());
    ...
    _d.CPGF_MD_TEMPLATE _operator<MetagenOperatorBitwise (*)(cpgf::GMetaSelf, const MetagenOperatorBitwise &)>(mopHolder >> mopHolder);
    _d.CPGF_MD_TEMPLATE _method("_opRightShift", (MetagenOperatorBitwise (*) (MetagenOperatorBitwise *, const MetagenOperatorBitwise &))&opErAToRWrapper_MetagenOperatorBitwise__opRightShift, cpgf::MakePolicy<cpgf::GMetaRuleExplicitThis >());
    _d.CPGF_MD_TEMPLATE _operator<MetagenOperatorBitwise (*)(cpgf::GMetaSelf, const std::string &)>(mopHolder >> mopHolder, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1> >());
