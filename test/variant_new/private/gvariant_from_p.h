...
struct CastVariant_RvalueReference
{
	...
	static ResultType cast(const GVariant & value)
	{
		...
		case GVariantType::vtBool: return (ResultType)helperFromVariant< ResultType, cpgf::GTypeList<const bool &&, bool &&, const volatile bool &&, volatile bool &&> >((bool &&) * (bool *)data.pointer); 
		case GVariantType::vtChar: return (ResultType)helperFromVariant< ResultType, cpgf::GTypeList<const char &&, char &&, const volatile char &&, volatile char &&> >((char &&) * (char *)data.pointer); 
		case GVariantType::vtWchar: return (ResultType)helperFromVariant< ResultType, cpgf::GTypeList<const wchar_t &&, wchar_t &&, const volatile wchar_t &&, volatile wchar_t &&> >((wchar_t &&) * (wchar_t *)data.pointer); 
		case GVariantType::vtSignedChar: return (ResultType)helperFromVariant< ResultType, cpgf::GTypeList<const signed char &&, signed char &&, const volatile signed char &&, volatile signed char &&> >((signed char &&) * (signed char *)data.pointer); 
		case GVariantType::vtUnsignedChar: return (ResultType)helperFromVariant< ResultType, cpgf::GTypeList<const unsigned char &&, unsigned char &&, const volatile unsigned char &&, volatile unsigned char &&> >((unsigned char &&) * (unsigned char *)data.pointer); 
		case GVariantType::vtSignedShort: return (ResultType)helperFromVariant< ResultType, cpgf::GTypeList<const signed short &&, signed short &&, const volatile signed short &&, volatile signed short &&> >((signed short &&) * (signed short *)data.pointer); 
		case GVariantType::vtUnsignedShort: return (ResultType)helperFromVariant< ResultType, cpgf::GTypeList<const unsigned short &&, unsigned short &&, const volatile unsigned short &&, volatile unsigned short &&> >((unsigned short &&) * (unsigned short *)data.pointer); 
		case GVariantType::vtSignedInt: return (ResultType)helperFromVariant< ResultType, cpgf::GTypeList<const signed int &&, signed int &&, const volatile signed int &&, volatile signed int &&> >((signed int &&) * (signed int *)data.pointer); 
		case GVariantType::vtUnsignedInt: return (ResultType)helperFromVariant< ResultType, cpgf::GTypeList<const unsigned int &&, unsigned int &&, const volatile unsigned int &&, volatile unsigned int &&> >((unsigned int &&) * (unsigned int *)data.pointer); 
		case GVariantType::vtSignedLong: return (ResultType)helperFromVariant< ResultType, cpgf::GTypeList<const signed long &&, signed long &&, const volatile signed long &&, volatile signed long &&> >((signed long &&) * (signed long *)data.pointer); 
		case GVariantType::vtUnsignedLong: return (ResultType)helperFromVariant< ResultType, cpgf::GTypeList<const unsigned long &&, unsigned long &&, const volatile unsigned long &&, volatile unsigned long &&> >((unsigned long &&) * (unsigned long *)data.pointer); 
		case GVariantType::vtSignedLongLong: return (ResultType)helperFromVariant< ResultType, cpgf::GTypeList<const signed long long &&, signed long long &&, const volatile signed long long &&, volatile signed long long &&> >((signed long long &&) * (signed long long *)data.pointer); 
		case GVariantType::vtUnsignedLongLong: return (ResultType)helperFromVariant< ResultType, cpgf::GTypeList<const unsigned long long &&, unsigned long long &&, const volatile unsigned long long &&, volatile unsigned long long &&> >((unsigned long long &&) * (unsigned long long *)data.pointer); 
		case GVariantType::vtFloat: return (ResultType)helperFromVariant< ResultType, cpgf::GTypeList<const float &&, float &&, const volatile float &&, volatile float &&> >((float &&) * (float *)data.pointer); 
		case GVariantType::vtDouble: return (ResultType)helperFromVariant< ResultType, cpgf::GTypeList<const double &&, double &&, const volatile double &&, volatile double &&> >((double &&) * (double *)data.pointer); 
