...
public:
	...
	GVariant invokeFunctor(const GVariant & instance, const GVariant & pa, const GVariant & pb, GPP_REPEAT(LESS_MAX_ARITY, VAR_PARAM_DEFAULT, GPP_EMPTY)) const;
...
#undef LESS_MAX_ARITY
#undef LESS_MAX_ARITY_1
