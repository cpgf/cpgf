...
public:
	...
	virtual GVariant callIndirectly(const GScriptName & name, GVariant const * const * params, size_t paramCount);
	virtual GVariant call(const GScriptName & name, const GVariant * params, size_t paramCount);
