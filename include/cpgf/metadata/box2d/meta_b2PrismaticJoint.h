...
#ifndef __META_B2PRISMATICJOINT_H
#define __META_B2PRISMATICJOINT_H
...
template <typename D, typename Policy>
void buildMetaClass_B2PrismaticJointDef(const cpgf::GMetaDataConfigFlags & config, D _d, const cpgf::GMetaDataNameReplacer * _r, const Policy & _p)
{
    (void)config; (void)_d; (void)_r; (void)_d; (void)_p;
    using namespace cpgf;
    ...
    _d.CPGF_MD_TEMPLATE _field(replaceName("localAxis1", _r), &D::ClassType::localAxis1, _p);
...
template <typename D, typename Policy>
void buildMetaFile_B2PrismaticJoint(const cpgf::GMetaDataConfigFlags & config, D _d, const cpgf::GMetaDataNameReplacer * _r, const Policy & _p)
{
    (void)config; (void)_d; (void)_r; (void)_d; (void)_p;
    using namespace cpgf;
    
    buildMetaClass_B2PrismaticJoint(config, _d, _r, _p);
    buildMetaClass_B2PrismaticJointDef(config, _d, _r, _p);
}
