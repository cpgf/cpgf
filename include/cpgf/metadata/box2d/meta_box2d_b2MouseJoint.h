...
template <typename D>
void buildMetaClass_B2MouseJoint(const cpgf::GMetaDataConfigFlags & config, D _d, const cpgf::GMetaDataNameReplacer * _r)
{
    ...
    _d.CPGF_MD_TEMPLATE _method(replaceName("SetTarget", _r), &D::ClassType::SetTarget);
...
template <typename D>
void buildMetaClass_B2MouseJointDef(const cpgf::GMetaDataConfigFlags & config, D _d, const cpgf::GMetaDataNameReplacer * _r)
{
    (void)config; (void)_d; (void)_r; (void)_d;
    using namespace cpgf;
    
    _d.CPGF_MD_TEMPLATE _constructor<void * ()>();
    _d.CPGF_MD_TEMPLATE _field(replaceName("target", _r), &D::ClassType::target);
