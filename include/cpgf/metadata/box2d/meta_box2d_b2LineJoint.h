...
template <typename D>
void buildMetaClass_B2LineJoint(const cpgf::GMetaDataConfigFlags & config, D _d, const cpgf::GMetaDataNameReplacer * _r)
{
...
template <typename D>
void buildMetaClass_B2LineJointDef(const cpgf::GMetaDataConfigFlags & config, D _d, const cpgf::GMetaDataNameReplacer * _r)
{
    (void)config; (void)_d; (void)_r; (void)_d;
    using namespace cpgf;
    ...
    _d.CPGF_MD_TEMPLATE _field(replaceName("localAxisA", _r), &D::ClassType::localAxisA);
