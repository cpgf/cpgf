...
#ifndef __META_B2POLYGONANDCIRCLECONTACT_H
#define __META_B2POLYGONANDCIRCLECONTACT_H
...
template <typename D, typename Policy>
void buildMetaFile_B2PolygonAndCircleContact(const cpgf::GMetaDataConfigFlags & config, D _d, const cpgf::GMetaDataNameReplacer * _r, const Policy & _p)
{
    (void)config; (void)_d; (void)_r; (void)_d; (void)_p;
    using namespace cpgf;
    
    buildMetaClass_B2PolygonAndCircleContact(config, _d, _r, _p);
}
