...
void doBuildMetaData_vector(const GMetaDataConfigFlags & config, MetaDefine define, const GMetaDataNameReplacer * replacer, const Policy & policy)
{
	...
	define
		...
		.CPGF_MD_TEMPLATE _method(replaceName("capacity", replacer), &T::capacity)
		...
		.CPGF_MD_TEMPLATE _method(replaceName("reserve", replacer), (void (T::*)(typename T::size_type)) &T::reserve)
