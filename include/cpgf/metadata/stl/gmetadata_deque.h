...
void doBuildMetaData_deque(const GMetaDataConfigFlags & config, MetaDefine define, const Policy & policy, const GMetaDataNameReplacer * replacer)
{
	...
	define
		...
		.CPGF_MD_TEMPLATE _method(replaceName("at", replacer), (typename T::reference (T::*)(typename T::size_type)) &T::at, policy)
		.CPGF_MD_TEMPLATE _method(replaceName("at", replacer), (typename T::const_reference (T::*)(typename T::size_type) const) &T::at, policy)
		...
		.CPGF_MD_TEMPLATE _method(replaceName("pop_front", replacer), (void (T::*)()) &T::pop_front)
		.CPGF_MD_TEMPLATE _method(replaceName("push_back", replacer), (void (T::*)(const typename T::value_type &)) &T::push_back, policy)
		.CPGF_MD_TEMPLATE _method(replaceName("push_front", replacer), (void (T::*)(const typename T::value_type &)) &T::push_front, policy)
