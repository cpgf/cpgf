...
void buildMetaClass_IMeshCache(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("removeMesh", (void (D::ClassType::*) (const IAnimatedMesh *const))&D::ClassType::removeMesh);
    _d.CPGF_MD_TEMPLATE _method("removeMesh", (void (D::ClassType::*) (const IMesh *const))&D::ClassType::removeMesh);
    _d.CPGF_MD_TEMPLATE _method("getMeshCount", &D::ClassType::getMeshCount);
    _d.CPGF_MD_TEMPLATE _method("getMeshIndex", (s32 (D::ClassType::*) (const IAnimatedMesh *const) const)&D::ClassType::getMeshIndex);
    _d.CPGF_MD_TEMPLATE _method("getMeshIndex", (s32 (D::ClassType::*) (const IMesh *const) const)&D::ClassType::getMeshIndex);
    ...
    _d.CPGF_MD_TEMPLATE _method("getMeshFilename", (_IRR_DEPRECATED_ const io::path & (D::ClassType::*) (const IAnimatedMesh *const) const)&D::ClassType::getMeshFilename);
    ...
    _d.CPGF_MD_TEMPLATE _method("setMeshFilename", (_IRR_DEPRECATED_ bool (D::ClassType::*) (const IAnimatedMesh *const, const io::path &))&D::ClassType::setMeshFilename, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1> >());
    ...
    _d.CPGF_MD_TEMPLATE _method("getMeshName", (const io::SNamedPath & (D::ClassType::*) (const IAnimatedMesh *const) const)&D::ClassType::getMeshName);
    ...
    _d.CPGF_MD_TEMPLATE _method("renameMesh", (bool (D::ClassType::*) (const IAnimatedMesh *const, const io::path &))&D::ClassType::renameMesh, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1> >());
