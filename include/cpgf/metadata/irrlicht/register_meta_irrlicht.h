...
GDefineMetaInfo createMetaClass_Global_cmeshbuffer();
...
GDefineMetaInfo createMetaClass_Global_line2d();
...
void registerMain_irrlicht(Meta _d)
{
    ...
    _d._class(createMetaClass_Global_aabbox3d());
    _d._class(createMetaClass_Global_cmeshbuffer());
    _d._class(createMetaClass_Global_coreutil());
    _d._class(createMetaClass_Global_dimension2d());
    ...
    _d._class(createMetaClass_Global_iimage());
...
//    _d._class(createMetaClass_Global_ireadfile());
    ...
    _d._class(createMetaClass_Global_iscenenode());
...
//    _d._class(createMetaClass_Global_iwritefile());
    _d._class(createMetaClass_Global_ixmlreader());
    _d._class(createMetaClass_Global_keycodes());
    _d._class(createMetaClass_Global_line2d());
    _d._class(createMetaClass_Global_line3d());
    _d._class(createMetaClass_Global_matrix4());
    _d._class(createMetaClass_Global_path());
    _d._class(createMetaClass_Global_plane3d());
    _d._class(createMetaClass_Global_position2d());
    _d._class(createMetaClass_Global_rect());
    ...
    _d._class(createMetaClass_Global_triangle3d());
    ...
    _d._class(createMetaClass_IIrrXMLReader());
...
//    _d._class(createMetaClass_IWriteFile());
    ...
    _d._class(createMetaClass_Line3d());
    _d._class(createMetaClass_Noiser());
    _d._class(createMetaClass_Plane3d());
    ...
    _d._class(createMetaClass_Triangle3d());
    _d._class(createMetaClass_Vector2d());
    _d._class(createMetaClass_Vector3d());
}
