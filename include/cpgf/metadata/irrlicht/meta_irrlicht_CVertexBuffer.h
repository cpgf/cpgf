...
void buildMetaClass_CVertexBuffer(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("_opSubscript", (video::S3DVertex & (*) (const CVertexBuffer *, const u32))&opErAToRWrapper_CVertexBuffer__opSubscript, cpgf::MakePolicy<cpgf::GMetaRuleExplicitThis >());
}
