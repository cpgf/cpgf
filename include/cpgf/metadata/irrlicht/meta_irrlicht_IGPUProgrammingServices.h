...
void buildMetaClass_IGPUProgrammingServices(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    ;
    _d.CPGF_MD_TEMPLATE _method("addHighLevelShaderMaterial", (s32 (D::ClassType::*) (const c8 *, const c8 *, E_VERTEX_SHADER_TYPE, const c8 *, const c8 *, E_PIXEL_SHADER_TYPE, IShaderConstantSetCallBack *, E_MATERIAL_TYPE, s32))&D::ClassType::addHighLevelShaderMaterial)
        ._default(copyVariantFromCopyable(0))
        ._default(copyVariantFromCopyable(video::EMT_SOLID))
        ._default(copyVariantFromCopyable(0))
    ...
    _d.CPGF_MD_TEMPLATE _method("addHighLevelShaderMaterialFromFiles", (s32 (D::ClassType::*) (const io::path &, const c8 *, E_VERTEX_SHADER_TYPE, const io::path &, const c8 *, E_PIXEL_SHADER_TYPE, const io::path &, const c8 *, E_GEOMETRY_SHADER_TYPE, scene::E_PRIMITIVE_TYPE, scene::E_PRIMITIVE_TYPE, u32, IShaderConstantSetCallBack *, E_MATERIAL_TYPE, s32))&D::ClassType::addHighLevelShaderMaterialFromFiles, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<3>, cpgf::GMetaRuleCopyConstReference<6> >())
        ...
        ._default(copyVariantFromCopyable("main"))
    ;
    _d.CPGF_MD_TEMPLATE _method("addHighLevelShaderMaterialFromFiles", (s32 (D::ClassType::*) (const io::path &, const c8 *, E_VERTEX_SHADER_TYPE, const io::path &, const c8 *, E_PIXEL_SHADER_TYPE, IShaderConstantSetCallBack *, E_MATERIAL_TYPE, s32))&D::ClassType::addHighLevelShaderMaterialFromFiles, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<3> >())
        ._default(copyVariantFromCopyable(0))
        ._default(copyVariantFromCopyable(video::EMT_SOLID))
        ._default(copyVariantFromCopyable(0))
        ._default(copyVariantFromCopyable(EPST_PS_1_1))
    ...
    _d.CPGF_MD_TEMPLATE _method("addHighLevelShaderMaterialFromFiles", (s32 (D::ClassType::*) (io::IReadFile *, const c8 *, E_VERTEX_SHADER_TYPE, io::IReadFile *, const c8 *, E_PIXEL_SHADER_TYPE, io::IReadFile *, const c8 *, E_GEOMETRY_SHADER_TYPE, scene::E_PRIMITIVE_TYPE, scene::E_PRIMITIVE_TYPE, u32, IShaderConstantSetCallBack *, E_MATERIAL_TYPE, s32))&D::ClassType::addHighLevelShaderMaterialFromFiles)
        ...
        ._default(copyVariantFromCopyable("main"))
    ;
    _d.CPGF_MD_TEMPLATE _method("addHighLevelShaderMaterialFromFiles", (s32 (D::ClassType::*) (io::IReadFile *, const c8 *, E_VERTEX_SHADER_TYPE, io::IReadFile *, const c8 *, E_PIXEL_SHADER_TYPE, IShaderConstantSetCallBack *, E_MATERIAL_TYPE, s32))&D::ClassType::addHighLevelShaderMaterialFromFiles)
        ._default(copyVariantFromCopyable(0))
        ._default(copyVariantFromCopyable(video::EMT_SOLID))
        ._default(copyVariantFromCopyable(0))
        ._default(copyVariantFromCopyable(EPST_PS_1_1))
